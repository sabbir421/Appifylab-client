...
import { AudienceIconButton, AudienceModal } from './AudienceSelector';
import UploadProgressBar from '@/app/components/UploadProgressBar';

export default function CreatePost() {
  const dispatch = useDispatch();
  const creating = useSelector((state) => state.feed.creating);
  ...
  return (
    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <form onSubmit={handleSubmit}>
        ...
        {imagePreview && (
          <div className="_create_post_image_preview">
            <img src={imagePreview} alt="Selected post" className="_create_post_image_preview_img" />
            {!isSubmitting && (
              <button type="button" className="_create_post_image_remove" onClick={clearImage} aria-label="Remove image">
                ×
              </button>
            )}
          </div>
        ...
        {isSubmitting && (
          <UploadProgressBar progress={uploadProgress} label={progressLabel} />
        )}
        ...
        <div className="_feed_inner_text_area_bottom">
          ...
          <div className="_feed_inner_text_area_btn">
            <button type="submit" className="_feed_inner_text_area_btn_link" disabled={isSubmitting || (!content.trim() && !imageFile)}>
